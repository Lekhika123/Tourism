                ...
                <div className='flex h-16 items-center justify-between'>
                    ...
                    <div className='hidden md:block'>
                        <div className='m-10 flex items-baseline'>
                            <a href="" className='rounded-md px-3 py-3 text-sm font-semibold text-ocean '>Home</a>
                            <a href="" className='rounded-md px-3 py-3 text-sm font-semibold text-ocean '>Worship Places</a>
                            <a href="" className='rounded-md px-3 py-3 text-sm font-semibold text-ocean '>Pilgrimages</a>
                            <a href="" className='rounded-md px-3 py-3 text-sm font-semibold text-ocean '>Prayer Guides</a>
                            <a href="" className='rounded-md px-3 py-3 text-sm font-semibold text-ocean '>About</a>
                            <a href="" className='rounded-md px-3 py-3 text-sm font-semibold text-ocean '>Contact Us</a>
                        </div>
                    </div>
                    <div className='hidden md:block'>
                        <button className="md:hidden text-2xl items-end focus:outline-none" onClick={() => setIsOpen(!isOpen)}>
